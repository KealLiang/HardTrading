...
def generate_market_stock_lists(data_dir: str = './data/astocks', output_dir: str = 'data'):
    """
...
def generate_board_stock_lists(data_dir: str = './data/astocks', output_dir: str = 'data'):
    """
